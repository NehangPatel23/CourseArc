...
export default function FilesPage() {
  ...
  const ICON_COLOR = "canvas-grayDark";
                  ...
                  <div className="text-xs text-gray-600">
                    ...
                    <button
                      ...
                      className={[
                        ...
                        "bg-transparent text-canvas-blue",
                        ...
                        <div className="min-w-0">
                          <button
                            ...
                            className={[
                              ...
                              "text-sm font-semibold text-canvas-grayDark hover:underline",
                              // ✅ hard reset against global button styling
                              "bg-transparent",
