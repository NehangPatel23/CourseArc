...
import { updateCourse, type Course } from "../utils/coursesStore";
...
export default function EditCourseModal({ open, course, onClose }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    showToast(`"${title.trim()}" updated`, "positive", "saved");
    onClose();
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md rounded-2xl bg-arc-paper p-6 shadow-xl">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-canvas-grayDark">Edit course</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <label className="block">
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-canvas-border px-3 py-2 text-sm"
            />
          </label>
          <label className="block">
