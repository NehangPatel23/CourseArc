                ...
                <div className="mt-2">
                  ...
                  {history.map((h) => (
                    <button
                      ...
                      type="button"
                      onClick={() => setQuery(h)}
                      className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-sm hover:bg-canvas-grayLight"
                    >
                ...
                <div key={group} className="mb-3">
                  ...
                  {items.map((r) => (
                    <button
                      ...
                      type="button"
                      onClick={() => go(r.href)}
                      className="flex w-full flex-col rounded-lg px-3 py-2 text-left text-sm hover:bg-canvas-grayLight"
                    >
                      <span className="font-medium text-canvas-grayDark">{r.title}</span>
